...
<head>
  ...
  <!-- Nucleo Icons -->
  <link href="{{asset('asset/auth/css/nucleo-icons.css')}}" rel="stylesheet" />
  <link href="{{asset('asset/auth/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <!-- Material Icons -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('asset/auth/css/material-dashboard.css?v=3.0.0')}}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="#">
            ...
            <span class="nav-link-text ms-1">web-Management</span>
          </a>
        </li>
        <li class="nav-item">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
    <nav style="background-color:skyblue;" class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
  ...
  <!--   Core JS Files   -->
  <script src="{{asset('asset/auth/js/core/popper.min.js')}}"></script>
  <script src="{{asset('asset/auth/js/core/bootstrap.min.js')}}"></script>
  <script src="{{asset('asset/auth/js/plugins/perfect-scrollbar.min.js')}}"></script>
  <script src="{{asset('asset/auth/js/plugins/smooth-scrollbar.min.js')}}"></script>
  <script src="{{asset('asset/auth/js/plugins/chartjs.min.js')}}"></script>
  <script>
