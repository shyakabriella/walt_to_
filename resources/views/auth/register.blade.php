      ...
      <div class="signUp-form form-wraper">
        <div>
          ...
          <div class="input-group">
            <div class="box">
              <span>
                <input placeholder="Full Name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus class="myInput @error('name') is-invalid @enderror" type="text" />
                @error('name')
          ...
          <div class="input-group">
            <div class="box">
              <span>
                <input placeholder="Email"  name="email" value="{{ old('email') }}" required autocomplete="email" class="myInput @error('email') is-invalid @enderror" id="email" type="email" />
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
          ...
          <div class="input-group">
            <div class="box">
              <span>
                <input placeholder="Password"  name="password" required autocomplete="new-password"  class="myInput @error('password') is-invalid @enderror" id="password" type="password" />
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
          ...
          <div class="input-group">
            <div class="box">
              <span>
                <input placeholder="Password-Confirm"  name="password_confirmation" required autocomplete="new-password"  class="myInput" id="password" type="password" />
